# -*- coding: utf-8 -*-
"""
Created on Sat Jan  6 13:25:10 2024
...
def process_all_files_in_folder_parallel(folder_path, max_workers):
...
def process_epub(epub_file_path):
    ...
    # 设置 max_workers 参数，控制同时运行的进程数量
    max_workers = 4  # 可以根据需要调整
    process_all_files_in_folder_parallel(output_folder, max_workers)
